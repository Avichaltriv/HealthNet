...
import { AvatarImage, AvatarFallback, Avatar } from "@/components/component/ui/avatar"
import { Input } from "@/components/component/ui/input"
import { CardTitle, CardHeader, CardContent, Card } from "@/components/component/ui/card"
      ...
      <header className="sticky top-0 z-20 border-b bg-white/80 backdrop-blur-sm dark:border-gray-800 dark:bg-gray-950">
        <div className="container mx-auto flex h-14 max-w-6xl items-center justify-between px-4 md:px-6">
          <Link className="flex items-center gap-2" href="#">
            ...
            <span className="font-bold text-green-500">HealthNet  </span>
          </Link>
